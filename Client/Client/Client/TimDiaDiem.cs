...
namespace Client
{
    public partial class TimDiaDiem : Form
    {
        ...
        private void TimDiaDiem_Load(object sender, EventArgs e)
        {
        ...
        private void ds_TP_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        void TimdiadiemCallBack(object sender, ServiceReference1.TimdiadiemCompletedEventArgs e)
        {
            try
            {
                dsnhahang = e.Result;
        ...
        void TimdiadiemtpCallBack(object sender, ServiceReference1.TimdiadiemtpCompletedEventArgs e)
        {
            try
            {
                dsnhahang = e.Result;
        ...
        void TimdiadiemtpquanCallBack(object sender, ServiceReference1.TimdiadiemtpquanCompletedEventArgs e)
        {
            try
            {
                dsnhahang = e.Result;
        ...
        void TimdiadiemduongCallBack(object sender, ServiceReference1.TimdiadiemduongCompletedEventArgs e)
        {
            try
            {
                dsnhahang = e.Result;
