...
namespace Client
{
    public partial class TimKhongGian : Form
    {
        ...
        private void TimKhongGian_Load(object sender, EventArgs e)
        {
        ...
        private void bt_Tim_Click(object sender, EventArgs e)
        {
            if (tb_Loai.Text != "")
            {
                ...
                client.TimkhonggianCompleted += new EventHandler<ServiceReference1.TimkhonggianCompletedEventArgs>(TimkhonggianCallBack);
                client.TimkhonggianAsync(tb_Loai.Text);
            }
            else
            {
                lv_dsketqua.Items.Clear();
        ...
        void TimkhonggianCallBack(object sender, ServiceReference1.TimkhonggianCompletedEventArgs e)
        {
            try
            {
                dsnhahang = e.Result;
