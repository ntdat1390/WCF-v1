...
namespace Client
{
    public partial class TimKhuyenMai : Form
    {
        ...
        {
            if (tb_loaikhuyenmai.Text!= "")
            {
                lv_dsketqua.Items.Clear();
                client = new ServiceReference1.Service1Client();
                client.TimkhuyenmaiCompleted += new EventHandler<ServiceReference1.TimkhuyenmaiCompletedEventArgs>(TimkhuyenmaiCallBack);
                client.TimkhuyenmaiAsync(tb_loaikhuyenmai.Text);
            }
            else
            {
                lv_dsketqua.Items.Clear();
        ...
        void TimkhuyenmaiCallBack(object sender, ServiceReference1.TimkhuyenmaiCompletedEventArgs e)
        {
            try
            {
                dsnhahang = e.Result;
