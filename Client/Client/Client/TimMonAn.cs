...
namespace Client
{
    public partial class TimMonAn : Form
    {
        ...
        private void TimMonAn_Load(object sender, EventArgs e)
        {
        ...
        private void bt_Tim_Click(object sender, EventArgs e)
        {
            if (tb_monan.Text != "")
            {
                ...
                client.TimmonanCompleted += new EventHandler<ServiceReference1.TimmonanCompletedEventArgs>(TimmonanCallBack);
                client.TimmonanAsync(tb_monan.Text);
            }
            else
            {
                lv_dsketqua.Items.Clear();
        ...
        void TimmonanCallBack(object sender, ServiceReference1.TimmonanCompletedEventArgs e)
        {
            try
            {
                dsnhahang = e.Result;
