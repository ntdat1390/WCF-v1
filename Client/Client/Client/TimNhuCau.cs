...
namespace Client
{
    public partial class TimNhuCau : Form
    {
        ...
        private void bt_Tim_Click(object sender, EventArgs e)
        {
            if (tb_nhucau.Text != "")
            {
                ...
                client.TimnhucauCompleted+= new EventHandler<ServiceReference1.TimnhucauCompletedEventArgs>(TimnhucauCallBack);
                client.TimnhucauAsync(tb_nhucau.Text);
            }
            else
            {
                lv_dsketqua.Items.Clear();
        ...
        void TimnhucauCallBack(object sender, ServiceReference1.TimnhucauCompletedEventArgs e)
        {
            try
            {
                dsnhahang = e.Result;
